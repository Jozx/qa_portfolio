...
**System Description:**
A web-based administrative platform allowing government agencies to manage vendor contracts, track deliverables, and process compliance audits.

**Key Features:**
*   **Vendor Registration & Onboarding** (Multi-step approval workflows).
*   **Contract Management** (Search, Filter, and Status updates).
*   **API Integrations** (External tax validation and compliance checks).
...
| Folder | Description |
| :--- | :--- |
| **01_Manual_Testing** | Test scenarios and cases derived from requirements (Sanity & Regression). |
